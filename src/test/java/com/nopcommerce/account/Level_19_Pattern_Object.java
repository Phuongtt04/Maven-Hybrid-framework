...
public class Level_19_Pattern_Object extends BaseTest {
    ...
    public void Register_02_InvalidEmail(Method method) {
        ...
        registerPage.enterToTextBoxByID(driver, "FirstName","Phượng");

        ExtentManager.getTest().log(Status.INFO , "Register_02 - Step 03: Enter to LastName textbox");
        registerPage.enterToTextBoxByID(driver, "LastName", "Test");
    ...
    public void Register_03_InvalidPassword(Method method) {
        ...
        registerPage.enterToTextBoxByID(driver,"Email","PhuongTest123@gmail.com");
    ...
    public void Register_06_Login_Success(Method method) {
        ...
        loginPage.enterToTextBoxByID(driver, "Password","123456");
